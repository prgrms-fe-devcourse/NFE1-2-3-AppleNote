...
const posts: Post[] = [
  {
    ...
    categories: [
      {
        categoryId: "0192aa1b-1e1c-7775-ab3a-99a65a243e0f",
        name: "Technology",
        createdAt: new Date("2024-01-01"),
  ...
  },
  {
    ...
    categories: [
      {
        categoryId: "0192aa1b-7277-7425-849f-eb52f8ca081c",
        name: "Schedules",
        createdAt: new Date("2024-03-01"),
  ...
  },
  {
    ...
    categories: [
      {
        categoryId: "d8249a93-ecfd-4f4b-922c-2b034b75c1fe",
        name: "Diary",
        createdAt: new Date("2024-04-01"),
...
export const handlers = [
  ...
  http.get(`${BASE_URL}/categories/:categoryId`, (req) => {
    ...
    const filteredPosts = posts.filter((post) =>
      post.categories.some((cat) => String(cat.categoryId) === String(categoryId))
    );
